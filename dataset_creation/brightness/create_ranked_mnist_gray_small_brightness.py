...
dataset_name = "ranked_mnist_gray_small_brightness"
...
for mode in ["train", "val", "test"]:
    ...
    for idx in range(set_size):
        ...
        for label in labels:
            ...
            put_digits.append((l, t, scaled_len, brightness, img_path, label))
        ...
        for rank, digit in enumerate(put_digits):
            l, t, scaled_len, brightness, img_path, label = digit
            ...
            img = np.repeat(np.expand_dims(img, axis=2), 3, axis=2) * brightness
